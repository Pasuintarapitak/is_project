...
if selected == "Machine Learning Documentation":
    ...
    """)
    st.markdown("""
        - MoblieNet : เป็นโครงสร้าง CNN ที่ Google คิดค้น ที่มีการช่วยลดขนาด model และเพิ่มความเร็ว และมีความแม่นยำสูง เพื่อให้ทำงานได้ดีบน Moblie Devices              
    """)
    ...
    """)
    st.markdown("""
            -   https://beeying.medium.com/เจาะลึกโครงสร้าง-cnn-eda3ae6b4f7a
            -   https://medium.com/@natthawatphongchit/มาลองดูวิธีการคิดของ-cnn-กัน-e3f5d73eebaa  
            -   https://chatgpt.com/
    """)
